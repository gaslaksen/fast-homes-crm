...
export class CompAnalysisService {
  ...
  // AI ARV lives in apps/api/src/ai-arv-calculation/ (Build 016).
  ...
  // calculateArv removed in Build 016. ARV is now produced by
  // AiArvCalculationService at POST /leads/:id/arv-calculation.
  // The deterministic stats it computed (median ppsf, weighted average,
  // comparable sales value) are reproduced in
  // apps/api/src/ai-arv-calculation/utils/arv-stats.ts.
