...
export function build(input: PromptInput): string {
  ...
  return [
    ...
    `      "reasoning": "1-3 sentences, specific to this comp",`,
    `      "flags": ["distressed_sale_likely", "era_mismatch", "size_outlier", "subtype_concern", "no_photos_for_verification", "renovation_likely", "short_dom_full_ask", ...],`,
