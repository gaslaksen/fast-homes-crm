...
export function MessageIcon({ size, color = '#000' }: IconProps) {
  return (
    <Svg {...base(size)} stroke={color}>
...
export function PhoneIcon({ size, color = '#000' }: IconProps) {
  return (
    <Svg {...base(size)} stroke={color}>
...
export function MailIcon({ size, color = '#000' }: IconProps) {
  return (
    <Svg {...base(size)} stroke={color}>
...
export function ZapIcon({ size, color = '#000' }: IconProps) {
  return (
    <Svg {...base(size)} stroke={color}>
...
export function ChevronRight({ size, color = '#000' }: IconProps) {
  return (
    <Svg {...base(size)} stroke={color}>
...
export function UsersIcon({ size, color = '#000' }: IconProps) {
  return (
    <Svg {...base(size)} stroke={color}>
