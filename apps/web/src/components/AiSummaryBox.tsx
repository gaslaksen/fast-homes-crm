...
export default function AiSummaryBox({ lead, onRefresh, onViewAnalysis }: AiSummaryBoxProps) {
  ...
  return (
    <div className="card border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-blue-50">
      <div className="flex items-center justify-between mb-3">
        <h3 className="font-bold flex items-center gap-2">
          AI Analysis
        </h3>
      ...
      <div className={`rounded-lg p-3 mb-3 ${
        lead.aiDealWorthiness === 'YES' ? 'bg-green-100 border border-green-300' :
        lead.aiDealWorthiness === 'NO' ? 'bg-red-100 border border-red-300' :
        ...
        {lead.aiProfitPotential && (
          <div className="bg-white rounded-lg p-2 border border-purple-100">
            ...
            <p className={`font-bold text-sm ${
              ...
              lead.aiProfitPotential === 'LOW' ? 'text-red-600' : 'text-gray-600'
            }`}>
              {lead.aiProfitPotential}
            </p>
          </div>
