...
const TABS = [
  ...
  // Overview and Activity retired 2026-06: the rail covers their content and
  // the right pane carries notes + the activity log.
...
export const DETAIL_TABS: LeadTab[] = ['disposition', 'communications'];
