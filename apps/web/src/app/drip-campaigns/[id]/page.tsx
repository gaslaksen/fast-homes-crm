...
const LEAD_STAGE_COLORS: Record<string, string> = {
  ...
  SOLD: 'bg-green-200 dark:bg-green-900/50 text-green-800 dark:text-green-300',
  SOLD_LOSS: 'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400',
  HELD_LONG_TERM: 'bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300',
